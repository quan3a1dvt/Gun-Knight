...
Cobra_SRun::Cobra_SRun(IMob* mob)
{
	m_mob = mob;
}

void Cobra_SRun::Init()
{
	m_animation = new Animation(*ASSET->getTexture("Mob/Cobra/Cobra_Run_Sprite_Sheet"), sf::Vector2i(8, 1), 0.1f);
...
void Cobra_SRun::Update(float deltaTime)
{
...
void Cobra_SRun::Render(sf::RenderWindow* window)
{
	window->draw(*m_animation);
}

Animation* Cobra_SRun::getSprite()
{
	return m_animation;
}
